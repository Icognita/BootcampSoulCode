...
export class CalculadoraCientificaComponent implements OnInit {
   ...
   */
    ...
    calcular():void{
      ...
      if (this.numero2 == 'null' && this.operacao == 'sqrt') {
        this.resultado = Math.sqrt(parseFloat(this.numero1)).toString()
        this.numero1 = this.resultado
        this.numero2 = 'null'
        this.operacao = 'null'
      }
      if (this.numero2 == 'null' && this.operacao == 'pwtwo') {
        this.resultado = Math.pow(parseFloat(this.numero1), 2).toString()
        this.numero1 = this.resultado
        this.numero2 = 'null'
        this.operacao = 'null'
      }
      if (this.numero2 == 'null' && this.operacao == 'pwthree') {
        this.resultado = Math.pow(parseFloat(this.numero1), 3).toString()
        this.numero1 = this.resultado
        this.numero2 = 'null'
        this.operacao = 'null'
      }
      if (this.numero2 == 'null') return
      this.resultado = this.calculadoraService.calcular(parseFloat(this.numero1), parseFloat(this.numero2), this.operacao).toString()
